...
<head>
  ...
  <title>Selectable Blocks → Export HTML</title>
...
<body>
  ...
  <div class="block optional" tabindex="0" data-id="block1" >
<p class="p-president">In the name of the Father<br>and of the son<br>and of the Holy Spirit</p>
